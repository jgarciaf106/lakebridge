...
Analyzer will control execution flow by dynamically requesting configuration parameters through prompts: source directory location, optional file name specification, and technology type for targeted analysis.

Below is the detailed explanation on the inputs required for Analyzer.
...
- `Source technology [Required]` - Select the underlying technology platform of the source files being analyzed.
